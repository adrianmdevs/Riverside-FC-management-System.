...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo2.png"width="150px"height="100px"/><br><br>
    <p class="text-justify">           
        Riverside FC is a an amatateur club that plays in the third-tier level. Established in early 2008, the club has enjoyed immense success and media limeligh following a stint of superb perfomances. The club first came into regional recognition after it's introduction in 2008. It was formed by an association of elite intelligenstia in the interests of eradicating drug abuse and crime in the locality</p><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>96-40301000 NAirobi</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>riverside@riverside.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>0748216929s</p><br><br><br>
     <center><img src="gitonga.jpg"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>copyright 2022 ,powered by  GITONGA ADRIAN</p>
</footer>
